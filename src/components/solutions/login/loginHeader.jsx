  ...
  return (
    <div className="relative w-full text-center sm:text-center md:text-start flex flex-col md:flex-row justify-between items-center  bg-white bg-opacity-70">
      <div className="h-fit pt-10 sm:pt-20  sm:pb-20 z-10">
        ...
        <div className="font-pre-bold text-3xl sm:text-[32px] md:text-[36px] lg:text-[56px] gradientText mt-3 leading-none">
      ...
      <PreloadImage
        ...
        className=" top-10 mb-10 md:mb-0 sm:pb-0 mt-10 sm:mt-0 md:absolute right-0 w-[70%]  md:w-[280px] lg:w-[380px] z-0  rounded-3xl object-contain shadow-all-around  xl:w-[400px]"
