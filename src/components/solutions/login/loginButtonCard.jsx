...
const Feature = ({ position, index, title, problem1, problem2, solution }) => {
  ...
  return (
    <motion.div
      ...
      className={`relative flex min-h-[250px] h-fit w-10/12 max-w-lg shrink-0 flex-col justify-between overflow-hidden p-8 shadow-lg md:w-2/5 ${
...
const features = [
...

  {
    ...
    problem2: '•사용자 데이터의 보호와 관리에 대한 더 나은 방법을 찾고 계신가요?',
    solution:
...

  {
    ...
    Icon: FiUpload,
    problem1:
      '•사용자들의 로그인 경험에 대한 피드백이 부담스러우신가요?',
