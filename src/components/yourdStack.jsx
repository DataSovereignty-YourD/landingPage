...
export default function YourdStack() {
  ...
  return (
    <div className="w-4/5 mx-auto h-screen">
      <div className="font-sf-pro-text font-bold text-center w-full py-20 text-3xl"> USE YourD, the best way to easiest way to build web3.0 product or project</div>
      <img src={YourDStack} alt="YourDStack" className=" object-contain w-3/5 bg-white relative mx-auto"/>
    </div>
