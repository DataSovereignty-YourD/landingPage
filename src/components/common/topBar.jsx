...
export default function TopBar() {
    ...
    return (
        <div className="w-full h-16">
            <div
                className={` bg-white  w-full flex flex-row justify-between items-center pl-4 sm:px-[5%] transition-all duration-300 fixed z-50`}
            >
                ...
                >
                    ...
                    <div ref={dropdownRef} className="relative w-full hidden sm:flex cursor-pointer">
                        <div
                            ...
                            className="flex items-center gap-2 px-4 py-[6px] font-pre-bold sm:rounded-full duration-50 bg-white  sm:hover:bg-[#fccc00] transition-colors border border-gray-400"
                        >
                            Company
                            <FiChevronDown
