...
import Kaia from "../../assets/img/kaiaLogo.png";
import Coineasy from "../../assets/img/coineasyLogo.png";
import Polygon from "../../assets/img/polygonLogo.png";
import NearKoreaDao from "../../assets/img/nearkoreadaoLogo.png";
export default function YourdAwards() {
  return (
    <div className="min-h-[800px] relative mt-32">
      <div className="flex justify-center items-center text-xl sm:text-4xl font-pre-bold mt-20">
        Awards
      </div>
      ...
      <div className="mt-20 text-xl sm:text-4xl font-pre-bold flex justify-center items-center">
      ...
      <div className="mt-12 text-xl sm:text-4xl font-pre-bold flex justify-center items-center">
        Partners
      </div>
      ...
      <div className="flex justify-center items-center gap-8 sm:gap-20 mt-2">
        <img src={Kaia} className="w-[100px] sm:w-[250px]" />
        <img src={Klaytn} className="w-[100px] sm:w-[250px]" />
        <img src={Polygon} className="w-[100px] sm:w-[250px]" />
      </div>
      <div className="flex justify-center items-center gap-8 sm:gap-20 mt-2">
        <img src={NearKoreaDao} className="w-[100px] sm:w-[250px]" />
        <img src={Coineasy} className="w-[100px] sm:w-[250px]" />
        <img src={""} className="w-[100px] sm:w-[250px]" />
      </div>
    </div>
  );
}
