...
import law from "../../assets/icon/lawIcon2.png";
...
export default function WhyYourD() {
  return (
    <div className="flex flex-col gap-4 mt-52 py-20 justify-center ">
      <div className="font-pre-bold font-extrabold text-xl sm:text-[44px] flex text-center itmes-center justify-center mb-10 sm:mb-20">
        ...
        <div className="grid grid-cols-6 items-start justify-center sm:gap-5 gap-10">
          {whyFeatures.map((feature, index) => (
            <div
              key={index}
              className="flex flex-col col-span-3 md:col-span-2  text-center min-h-[220px] sm:min-h-[280px]"
            >
              <div className="flex mx-auto justify-center items-center  sm:w-[60px] sm:h-[60px] md:w-[80px] md:h-[80px] rounded-full bg-white overflow-visible">
                <img
                  src={feature.img}
                  alt={feature.title}
                  className="absolute object-contain w-[24px] h-[24px]  sm:w-[36px] sm:h-[36px]"
                />
              </div>
